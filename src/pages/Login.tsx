...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="mx-4 flex w-full max-w-sm flex-col items-center gap-6 rounded-2xl border bg-card p-10 shadow-lg">
        <div className="flex flex-col items-center gap-3">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary">
            <ChefHat className="h-8 w-8 text-primary-foreground" />
          </div>
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Recipe Tracker</h1>
          <p className="text-center text-sm text-muted-foreground">
            Track, rate, and discover your favorite recipes
          </p>
        </div>
